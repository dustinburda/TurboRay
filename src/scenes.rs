...
pub fn scene1() -> World {
    let material1 = Rc::new(Material::Matte(Color::new(255.0, 51.0, 255.0)));
    let mut sphere1: Box<dyn Shape> = Box::new(Sphere::new(1.0, Some(material1)));

    sphere1.set_transform(translation(0.0, 0.0, -10.0) * scale(1.0, 1.0, 1.0));
    ...
    // sphere2.set_transform(translation(0.0, 0.0, 0.0) * scale(1.0, 0.5, 1.0));
