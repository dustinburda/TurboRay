...
pub fn scene1() -> World {
    ...
    sphere1.set_transform(translation(0.0, 0.0, 3.0) * scale(0.5, 1.5, 1.0));
    ...
    sphere2.set_transform(translation(1.0, 0.0, 1.0));
    ...
    let light: PointLight = PointLight::new(1.0, Vec::new([0.0, 0.0, 0.0]));
