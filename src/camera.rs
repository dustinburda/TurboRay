...
impl ProjCamera {
    pub fn new(focal_distance: f64) -> ProjCamera {
        ...
        ProjCamera {
            ...
            viewport_u: Vec::new([7.0 * aspect_ratio / (WIDTH as f64), 0.0, 0.0]), //TODO: CHANGE TO 2.0
            viewport_v: Vec::new([0.0, - 7.0 / (HEIGHT as f64), 0.0]) // TODO CHANGE to 2.0
        }
    }
...
impl Camera for ProjCamera {
    fn cast_ray(&self, x: f64, y: f64, mode: AliasMode) -> Ray {
        ...
        let upper_left_corner = Vec::new([-3.5 * aspect_ratio, 3.5 , 0.0]); // TODO: change to 1.0
        let dir =  match mode {
